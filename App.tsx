...
export default function App() {
  ...
  const fetchPoke = async () => {
    ...
    const response = await axios
      .get(`https://pokeapi.co/api/v2/pokemon?${genPoke}`)
      .then((json) => {
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <Box bgColor="$white">
          ...
          <HStack
            ...
            gap={10}
            alignItems="center"
            /*borderBottomLeftRadius={15} borderBottomRightRadius={15}*/ justifyContent="center"
            flexDirection="row"
          >
            <Text
              left={5}
              ...
              <Box mt={10} mb={120} alignItems="center">
                {pokeListFiltred.length === 0 ? (
                  <Box alignItems="center" justifyContent="center">
                    <Image
                      source={require("./src/assets/erro404.png")}
                      alt="pokenon nao encontrado"
                      width={300}
                      h={300}
                    />
