    ...
    >
      ...
      <ModalContent w={"100%"} h={"100%"} bgColor="#1E1E1E">
        ...
        <ModalHeader borderRadius={10}>
          <ImageBackground
            source={require("../assets/fundoPoke.jpg")}
          ...
          >
            <HStack justifyContent="space-between" p={4}>
              <HStack gap={10}>
                ...
                <Heading size="lg" color="$white" right={10}>
                  {poke.name}
                </Heading>
              </HStack>
            ...
            <Image
              w={"100%"}
              h={"90%"}
              source={{ uri: shiny ? imageShyne : image }}
              alt={poke.name}
              resizeMode="contain"
            />
          </ImageBackground>
        ...
        <ModalBody bgColor={"$warmGray300"}>
          <Center mt={10}>
            <Text mb={5} color="black" fontWeight="$normal" fontSize={40}>
              {poke.name}
            </Text>
            <HStack>
          ...
          <Center mt={10}>
            <Text color="black" fontSize={25} mb={5}>
              Base Stats
            </Text>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {baseStat >= 60 ? (
                          <Text right={2} fontSize={12} color="white">
                            {baseStat}/300
                          </Text>
                        ) : (
                          ""
                      ...
                      >
                        {baseStat < 60 ? (
                          <Text left={2} fontSize={12} color="black">
                            {baseStat}/300
                          </Text>
                        ) : (
                          ""
          ...
          <Center mt={10}>
            ...
            <TouchableOpacity
              onPress={() => setShiny((prevShiny) => !prevShiny)}
            >
              <Center
                mt={5}
                w={80}
                bgColor={shiny ? "black" : "$warmGray300"}
                borderColor={shiny ? "$warmGray300" : "black"}
                borderWidth={2}
                borderRadius={10}
              >
                <Text padding={10} color={shiny ? "$warmGray300" : "black"}>
                  {shiny ? "Shiny" : "Normal"}
                </Text>
              </Center>
            </TouchableOpacity>
